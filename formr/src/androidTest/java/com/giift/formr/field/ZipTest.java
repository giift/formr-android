...
public class ZipTest {
  ...
  @Before
  public void ScrollToZip() {
    onView(withId(R.id.zip)).perform(closeSoftKeyboard());
    onView(withId(R.id.zip)).perform(scrollTo());
    onView(withId(R.id.zip)).check(matches(isDisplayed()));
    Matcher<View> linearLayout = allOf(isAssignableFrom(LinearLayout.class), withParent(withId(R.id.zip)));
